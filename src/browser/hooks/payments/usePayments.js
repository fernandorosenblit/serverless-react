...
export default paymentOptionsLink => {
  ...
  const handleAvailablePaymentMethods = (methods, isStripe) => {
  ...
  }, [paymentsOptionsMeta?.success, wereStripeMethodsRetrieved, availablePaymentMethods.length]);
