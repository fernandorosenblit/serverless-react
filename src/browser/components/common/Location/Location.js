...
const Location = () => {
  ...
  const { searchTerm, handleInputChange, handleOptionClick, options, isLoading } = useChangeLocation();
    ...
    >
      ...
      <Select
        ...
        components={{
          ...
          MenuList: (props) => <LocationCustomMenuList {...{ ...props, onCurrentLocationClick: handleBlur }} />,
        }}
      />
    </div>
  );
