  ...
  return (
    ...
    >
      <Input
        ...
        {...props}
        {...inputProps}
        className={cn("input", { "with-icon": !!Icon }, { "icon-left": iconLeft }, inputProps.className)}
      />
      {Icon && (
        <IconWrapper
          {...iconWrapperProps}
      ...
      {!!clearSearch && value && (
        <ClearSearch
          ...
          {...clearSearchProps}
          className={cn("input-icon clear-search", { "icon-left": !iconLeft }, clearSearchProps.className)}
        >
          <Cancel />
        </ClearSearch>
      )}
