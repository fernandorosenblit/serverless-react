...
const FindAMovie = ({ onSale, comingSoon, openingThisWeek, meta }) => {
  ...
  return (
    <section className="fam-section">
      ...
      {category === CATEGORIES.onSale && <MovieCarousel movieList={onSale} meta={meta} category={category} />}
      {category === CATEGORIES.comingSoon && <MovieCarousel movieList={comingSoon} meta={meta} category={category} />}
