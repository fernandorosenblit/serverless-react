...
import SmallScreenImage from "assets/images/seatMap/small-screen.svg";
  ...
  return (
    <div className="seat-map-preview">
      <div className="seat-map-preview__screen-zone">
        ...
        <span className="seat-map-preview__title caption-two semibold">{intl.formatMessage(labels.title)}</span>
