...
import ScreenImage from "assets/images/seatMap/screen.svg";
    ...
    <div className="seat-map">
      <div className="seat-map__inner">
          ...
          <PrismaZoom maxZoom={8} ref={prismaZoomRef} className="seat-map__zoom-container">
            <div className="seat-map__interactive">
              ...
              <div className="seat-map__seats">
                {zones?.map((zone) => (
                  <SeatZone key={`zone-${zone.areaIndex}`} zone={zone} />
                ))}
              </div>
            </div>
          </PrismaZoom>
        ...
        <div className="seat-map__seating-legends">
          ...
          {SeatWithLegend([SEAT_TYPES.standard], SEAT_STATUS.socialDistance, seatLabels.socialDistance)}
          {SeatWithLegend(
