...
export const FEATURED_MOVIE_ASPECT_RATIO = (100 * FEATURED_MOVIE_DIMENSIONS.height) / FEATURED_MOVIE_DIMENSIONS.width;
...
export const MOVIE_CARD_ASPECT_RATIO = (100 * MOVIE_CARD_DIMENSIONS.height) / MOVIE_CARD_DIMENSIONS.width;
